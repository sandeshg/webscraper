<?php
namespace App\Sandesh\TextAnalysis\Tokenizers;

class Tokenizer
{
    protected $tokenExp = null;
    ...
    {
        return $this->StrToTokenConvertor($string);
    }

    protected function StrToTokenConvertor($string)
    {
        $token = strtok($string, $this->tokenExp);
        $tokens = array();
        while ($token !== false) {
